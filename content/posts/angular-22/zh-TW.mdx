...
連續三個 Angular major release 很容易被寫成三篇功能清單，讀完還是不知道框架到底往哪裡走。這篇乾脆把 20、21、22 排在一起看，反而比較能看出同一條演進路線。
...
參考：[Angular Roadmap](https://angular.dev/roadmap)、[Angular v21](https://angular.dev/events/v21)、[Angular releases](https://angular.dev/reference/releases)
