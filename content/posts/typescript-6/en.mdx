...
TypeScript 6 occupies an awkward position because the Go-based TypeScript 7 took most of the attention. For a real upgrade, however, version 6 is difficult to skip: it marks which parts of the old world will not make the move.
