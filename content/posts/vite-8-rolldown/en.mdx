...
Vite 8 looks like another major release, but the change underneath is substantial: the core responsible for production builds is being replaced. The interesting question is not the new name, but whether a tool can change engines without making users repair configuration every day.
