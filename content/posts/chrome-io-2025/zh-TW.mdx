...
我看完今年 Google I/O 的整理，腦中第一句話是：「好，又是 AI。」不是說 AI 不重要，只是整場資訊塞得太滿，於是我又回頭把清單翻了一次，先把那些華麗 demo 放旁邊，挑出幾個會讓日常 UI 少寫一點 JavaScript 的東西。
...
新功能通常還有瀏覽器版本和細節差異，但至少未來做常見介面時，可以先看看 HTML 和 CSS 是否已經能處理，不必第一時間安裝更多依賴。
