...
Tailwind Plus adding Vanilla JavaScript support can look like a step backward at first. After years of framework adoption, why return to plain JavaScript? For small interactions such as dialogs and dropdowns, the choice makes quite a bit of sense.
