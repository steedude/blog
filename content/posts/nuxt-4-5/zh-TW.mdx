...
如果專案用預設的 Vite 就能順利開發和建置，我會先繼續用它。如果團隊以前用 webpack，累積了很多客製設定或處理特殊檔案的工具，Rspack 可能比較容易沿用這些做法，值得試試。真的要換之前，我會挑一個包含專案常用功能的頁面，確認換過去後功能是否正常、設定要改多少，以及建置能快多少。這樣才知道換工具值不值得，不能只看宣傳裡的速度數字。
