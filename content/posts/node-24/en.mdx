...
A frontend role may not require writing a Node.js backend, but a modern frontend project can hardly avoid Node. Starting a dev server, running tests, and installing packages all depend on it, even if we rarely stop to notice.
