...
The release is mainly a foundation update: it pairs with Vite 8 and speeds up content processing. Build efficiency becomes more visible as the number of articles grows.
