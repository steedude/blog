...
I would start the upgrade by trying it in the editor on a larger project, comparing startup, go-to-definition, renaming, and error updates, and checking that these features work correctly. Then I would run both compilers on the same TypeScript code and compare the time taken and the results. If anything differs, I would work through the differences before upgrading the whole team.
