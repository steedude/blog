...
After more than a year, TypeScript's Go port is no longer only a plan in a presentation. "The native version is much faster" is the memorable headline, but support from surrounding tools is the more practical upgrade question.
