...
A React vulnerability that can execute code on a server would have sounded odd a few years ago. Wasn't React a UI library? Once Server Components moved part of the work to the server, that boundary stopped being so clear.
